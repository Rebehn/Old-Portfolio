$(() => {
  ...
  function showProjectThree() {
    $shadeBox.show();
    $projectInfoBox.show();
    $projectInfoBox.html('<a href="#portfolio" id="closeProjectButtonLink"><div class="closeProjectButton">X</div></a><h3>Event Cupid</h3><p>Centred around the Google Maps and Skidde API, this app finds upcoming events around a central location between the user and their chosen partner. Users are able to select a date range for the available events and then follow a link to purchase tickets for that event.</p><a href="https://eventcupid.herokuapp.com/" target="_blank"><div class="projectButton">View Project</div></a><a href="https://github.com/pedroeldiablo/WDI-Project" target="_blank"><div class="projectButton" id="viewCodeButton">View Code</div></a>');
    const $closeProjectButton = $('.closeProjectButton');
    $closeProjectButton.on('click', hideProject);
  }
